<template>
	<div>
		<div class="header">
			...
			<lazy-image
				imageName="garden"
				description="Beer garden ready for a wedding"
			/>
		</div>

		<div
			class="container container--style container--bottom-gap p-8 sm:p-10 md:p-12 xl:p-16"
		>
			<div class="row m-auto mt-0 mb-8">
				<div class="text-center">
					<h2 class="text-underline text-5xl mt-10 mb-20">
						O' Driscolls Bar & Beer Garden
					</h2>
				</div>
				<p class="text-lg max-w-lg m-auto mb-16">
					Ballyduff House, as well as hosting weddings, is also the
					perfect settings for private parties, events, conferences,
					and social gatherings of any kind. Depending on the season,
					the use of the House together with the extensive and
					beautifully kept grounds and walled garden can make for a
					highly successful and memorable social engagement. Marquees,
					catering, floral display and transport to suit your needs
					for any occasion can be provided by prior arrangement.
				</p>
			</div>
			...
			<div class="row flex flex-wrap py-24">
				<div class="w-full lg:mb-0 lg:w-1/2 lg:pr-8">
					<img
						class="image--style"
						src="~/assets/images/hobys-party.jpg"
						alt
					/>
				</div>
				<div class="w-full lg:w-1/2 lg:pl-8 mt-12">
					...
					<p>
						...
						elit. Necessitatibus animi quod voluptas temporibus
						debitis est accusamus similique corrupti.
					</p>
			...
			<div class="row flex flex-wrap flex-col-reverse lg:flex-row py-24">
				<div class="w-full lg:w-1/2 lg:pr-8 mt-12">
					...
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing
						elit. Necessitatibus animi quod voluptas temporibus
						debitis est accusamus similique corrupti! Fuga deleniti
						cum alias et eos recusandae perferendis odio vitae dicta
						a ad, voluptatibus officia voluptatum praesentium,
						aliquid id. Nemo minima accusamus sint, illum doloribus
						aliquam minus voluptatem harum, nisi nulla aspernatur?
					</p>
			...
			<!-- Facebook Messenger -->
			<div
				class="row max-w-md m-auto my-16 text-center text-xl leading-loose"
			>
				<p>
			...
			<div class="row p-8 md:py-0">
				<div class="quick-info">
					...
					<div class="quick-info__item">
						...
						<p>
							Tag your photo with
							<strong class="text-orange">#odriscollsbar</strong>
							to see them displayed below.
						</p>
					</div>
					...
					<div class="quick-info__item">
						...
						<div class="icons flex">
							<div class="icon">
								<img
									src="~/assets/images/icons/Facebook-round.svg"
								/>
							</div>
							<div class="icon">
								<img
									src="~/assets/images/icons/Twitter-round.svg"
								/>
							</div>
							<div class="icon">
								<img
									src="~/assets/images/icons/Instagram-round.svg"
								/>
							</div>
						</div>
					</div>
					...
					for (let i = 0; i < images.length; i++) {
						...
						if (i < this.numberOfImagesToDisplay) {
							var newObj = {
								...
								description:
									img.node.edge_media_to_caption.edges[0].node
										.text
							};
