<template>
  <div>
    ...
    <div class="container container--style container--bottom-gap p-8 sm:p-10 md:p-12 xl:p-16">
        <div class="row max-w-md m-auto mt-8 mb-8">
            <div class=" text-center">
                <h2 class="text-underline text-4xl mt-0 mb-12">O' Driscolls Bar</h2>
            </div>
        ...
        <div class="row flex flex-wrap py-16 items-center">
            ...
            <div class="w-full lg:w-1/2 lg:pl-8">
                ...
                <nuxt-link to="/bookings" class=" inline-block bg-orange hover:bg-orange-dark text-white font-semibold py-2 px-4 rounded">Book an Event</nuxt-link>
            </div>
        </div>
        ...
        <div class="row flex flex-wrap flex-col-reverse lg:flex-row py-16 items-center">
            <div class="w-full lg:w-1/2 lg:pr-8">
                ...
                <nuxt-link to="/weddings" class="inline-block bg-orange hover:bg-orange-dark text-white font-semibold py-2 px-4 rounded">More info</nuxt-link>
            </div>
        ...
        <div class="row max-w-md m-auto my-16 text-center text-xl leading-loose">
            <p>Have a quick question?   Get in touch via 
            <a href="#" style="white-space: nowrap" class="bg-blue hover:bg-blue-dark text-blue-lightest mt-2 inline-block ml-4 font-semibold py-2 px-4 rounded shadow">
            <img id="facebook-messenger-icon" width="24" height="24" src="~/assets/images/icons/messenger.svg" alt="facebook messenger icon"> Messenger</a></p>
        </div><!-- Facebook Messenger -->
